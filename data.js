...
const PHRASES = [
  ...
  {
    id: 'bank_ph', category: 'Банк и деньги', icon: '🏦', color: '#000091',
    phrases: [
      { greek: 'Je voudrais ouvrir un compte', transcription: 'Жё вудрэ́ уври́р эн конт', translation: 'Я хотел бы открыть счёт', note: 'Счёт открывают не в окне, а на встрече с консультантом по записи.' },
      { greek: 'Quels documents faut-il ?', transcription: 'Кэль докюма́н фо-ти́ль ?', translation: 'Какие документы нужны?', note: 'Список у каждого банка свой — уточняйте до визита, экономит поездку.' },
      { greek: 'Voici mon justificatif de domicile', transcription: 'Вуаси́ мон жюстификати́ф дё домиси́ль', translation: 'Вот моё подтверждение адреса', note: 'Счёт за свет или интернет на ваше имя, обычно не старше трёх месяцев.' },
      { greek: 'Quels sont les frais de tenue de compte ?', transcription: 'Кэль сон ле фрэ дё тёню́ дё конт ?', translation: 'Какая плата за обслуживание счёта?', note: 'Спросить надо: платное обслуживание есть почти везде.' },
      { greek: 'Je voudrais l’offre la plus simple', transcription: 'Жё вудрэ́ лёфр ля плю сэмпль', translation: 'Мне нужен самый простой тариф', note: 'Отсекает пакет со страховками, который предлагают по умолчанию.' },
      { greek: 'Je voudrais faire un virement', transcription: 'Жё вудрэ́ фэр эн вирма́н', translation: 'Я хотел бы сделать перевод', note: 'Virement — перевод, который инициируете вы.' },
      { greek: 'Je voudrais annuler ce prélèvement', transcription: 'Жё вудрэ́ анюле́ сё прелевма́н', translation: 'Я хотел бы отменить это автосписание', note: 'Prélèvement инициирует получатель — отменяют и в банке, и у поставщика.' },
      { greek: 'J’ai perdu ma carte, je fais opposition', transcription: 'Жэ пердю́ ма карт, жё фэ опозисьо́н', translation: 'Я потерял карту, блокирую её', note: 'Faire opposition — блокировка карты. Есть круглосуточный номер.' },
      { greek: 'Je n’ai pas reconnu cette opération', transcription: 'Жё нэ па рёконю́ сэт операсьо́н', translation: 'Я не узнаю эту операцию', note: 'Начало разговора об оспаривании списания.' },
      { greek: 'Quel est le solde de mon compte ?', transcription: 'Кэль э лё сольд дё мон конт ?', translation: 'Какой остаток на моём счёте?', note: 'Solde — остаток. Découvert — уход в минус.' },
      { greek: 'Vous pouvez m’envoyer mon RIB ?', transcription: 'Ву пуве́ манвуайе́ мон риб ?', translation: 'Можете прислать мне мой RIB?', note: 'Обычно скачивается в приложении за один клик.' },
      { greek: 'Je paie par carte', transcription: 'Жё пэ пар карт', translation: 'Я плачу картой', note: 'В маленьких заведениях бывает минимальная сумма для оплаты картой.' },
      { greek: 'Vous acceptez les chèques ?', transcription: 'Ву аксептэ́ ле шэк ?', translation: 'Вы принимаете чеки?', note: 'Чеки во Франции ещё живы: залоги, секции, ассоциации.' },
      { greek: 'Je voudrais retirer cent euros', transcription: 'Жё вудрэ́ рётирэ́ сан ёро́', translation: 'Я хотел бы снять сто евро', note: 'В чужом банкомате после нескольких бесплатных снятий берут комиссию.' },
      { greek: 'Je vous demande une attestation de refus', transcription: 'Жё ву дёма́нд юн атестасьо́н дё рёфю́', translation: 'Прошу выдать письменный отказ', note: 'С ним идут в Banque de France по праву на базовый счёт.' },
    ]
  },
  {
    id: 'work_ph', category: 'Работа и офис', icon: '💼', color: '#000091',
    phrases: [
      { greek: 'Bonjour, je suis le nouveau', transcription: 'Бонжу́р, жё сюи́ лё нуво́', translation: 'Здравствуйте, я новый сотрудник', note: 'Женский вариант — la nouvelle. Здороваться принято с каждым лично.' },
      { greek: 'Je travaille dans le service marketing', transcription: 'Жё трава́й дан лё серви́с маркети́нг', translation: 'Я работаю в отделе маркетинга', note: 'Service — отдел, а не «сервис».' },
      { greek: 'On peut se tutoyer ?', transcription: 'Он пё сё тютуайе́ ?', translation: 'Можем перейти на «ты»?', note: 'Предлагает старший по возрасту или должности. Не предлагайте первым.' },
      { greek: 'Est-ce que vous avez cinq minutes ?', transcription: 'Эскё вуз-аве́ сэнк миню́т ?', translation: 'У вас есть пять минут?', note: 'Вежливый вход в разговор с руководителем.' },
      { greek: 'Pourriez-vous m’envoyer le document ?', transcription: 'Пурье́-ву манвуайе́ лё докюма́н ?', translation: 'Не могли бы вы прислать мне документ?', note: 'Условное наклонение здесь обязательно: прямая форма звучит как приказ.' },
      { greek: 'Je vous mets en copie', transcription: 'Жё ву мэ ан копи́', translation: 'Ставлю вас в копию', note: 'Стандартная офисная формула в переписке.' },
      { greek: 'Je te reviens là-dessus', transcription: 'Жё тё рёвье́н ля-дёсю́', translation: 'Вернусь к тебе с ответом', note: 'Не «возвращаюсь», а «дам ответ позже».' },
      { greek: 'On fait un point demain ?', transcription: 'Он фэ эн пуэ́н дёмэ́н ?', translation: 'Сверимся завтра?', note: 'Faire un point — короткая рабочая сверка.' },
      { greek: 'Je ne suis pas tout à fait d’accord', transcription: 'Жё нё сюи́ па тут-а-фэ дако́р', translation: 'Я не совсем согласен', note: 'Прямое «нет» во французской переговорной культуре смягчают.' },
      { greek: 'C’est compliqué', transcription: 'Сэ комплике́', translation: 'Это сложно', note: 'Чаще всего означает вежливый отказ, а не описание трудности.' },
      { greek: 'Je suis débordé en ce moment', transcription: 'Жё сюи́ дебордэ́ ан сё мома́н', translation: 'Я сейчас завален работой', note: 'Мягкий способ отказаться от новой задачи.' },
      { greek: 'Je voudrais poser des congés', transcription: 'Жё вудрэ́ позе́ де конжэ́', translation: 'Я хотел бы взять отпуск', note: 'Poser des congés — подать заявление на отпускные дни.' },
      { greek: 'J’ai un arrêt de travail', transcription: 'Жэ эн арэ́ дё трава́й', translation: 'У меня больничный', note: 'Лист передают работодателю и в страховую в течение 48 часов.' },
      { greek: 'Cordialement', transcription: 'Кордьяльма́н', translation: 'С уважением (в письме)', note: 'Нейтральная концовка письма. Теплее — «Bien à vous».' },
      { greek: 'Bonne journée !', transcription: 'Бон журнэ́ !', translation: 'Хорошего дня!', note: 'Стандартное прощание с коллегами и в любом окне.' },
    ]
  },
  {
    id: 'school_ph', category: 'Школа и дети', icon: '🎒', color: '#000091',
    phrases: [
      { greek: 'Je voudrais inscrire mon enfant à l’école', transcription: 'Жё вудрэ́ энскри́р мон анфа́н а леко́ль', translation: 'Я хотел бы записать ребёнка в школу', note: 'Сначала мэрия, потом директор школы.' },
      { greek: 'Nous venons d’arriver en France', transcription: 'Ну вёно́н дариве́ ан франс', translation: 'Мы недавно приехали во Францию', note: 'Открывает разговор о языковой поддержке для ребёнка.' },
      { greek: 'Mon enfant ne parle pas encore français', transcription: 'Мон анфа́н нё парль па анко́р франсэ́', translation: 'Мой ребёнок пока не говорит по-французски', note: 'Дальше спрашивайте про UPE2A — классы поддержки.' },
      { greek: 'Il est en CP cette année', transcription: 'Иль э ан сэ-пэ́ сэт анэ́', translation: 'В этом году он в первом классе', note: 'CP — первый класс начальной школы, дальше CE1, CE2, CM1, CM2.' },
      { greek: 'Je voudrais l’inscrire à la cantine', transcription: 'Жё вудрэ́ лянскри́р а ля канти́н', translation: 'Я хотел бы записать его в столовую', note: 'Оплата столовой обычно зависит от дохода семьи.' },
      { greek: 'Il a une allergie aux arachides', transcription: 'Иль а юн алержи́ о арашид', translation: 'У него аллергия на арахис', note: 'При аллергии школа оформляет PAI — индивидуальный план.' },
      { greek: 'J’ai bien lu et signé', transcription: 'Жэ бье́н лю э синье́', translation: 'Прочитал и подписал', note: 'Ответ на записку в carnet de liaison — дневнике связи.' },
      { greek: 'Mon enfant était malade', transcription: 'Мон анфа́н этэ́ маля́д', translation: 'Мой ребёнок болел', note: 'Пропуск нужно объяснить письменно: absence à justifier.' },
      { greek: 'Comment se passe l’année pour lui ?', transcription: 'Кома́н сё пас лянэ́ пур люи́ ?', translation: 'Как у него проходит год?', note: 'Открывающий вопрос на родительском собрании.' },
      { greek: 'Il a des difficultés en quoi ?', transcription: 'Иль а де дификюльтэ́ ан куа́ ?', translation: 'В чём у него трудности?', note: 'Прямой вопрос учителю, воспринимается нормально.' },
      { greek: 'Qu’est-ce qu’on peut travailler à la maison ?', transcription: 'Кэскон пё травайе́ а ля мэзо́н ?', translation: 'Над чем можно поработать дома?', note: 'Учителя ценят такой вопрос от родителей.' },
      { greek: 'Excusez-moi, mon français n’est pas parfait', transcription: 'Экскюзэ́-муа́, мон франсэ́ нэ па парфэ́', translation: 'Извините, мой французский несовершенен', note: 'После этой фразы почти все переходят на более простой язык.' },
      { greek: 'Vous pouvez me l’écrire ?', transcription: 'Ву пуве́ мё лекри́р ?', translation: 'Можете мне это написать?', note: 'Названия документов и дат лучше получать в письменном виде.' },
      { greek: 'À quelle heure finit l’école ?', transcription: 'А кэль ёр фини́ леко́ль ?', translation: 'Во сколько заканчиваются уроки?', note: 'Продлёнка называется périscolaire или étude.' },
      { greek: 'Merci beaucoup pour votre suivi', transcription: 'Мерси́ боку́ пур вотр сюиви́', translation: 'Спасибо за внимание к ребёнку', note: 'Хорошая завершающая фраза разговора с учителем.' },
    ]
  },
  {
    id: 'housing_ph', category: 'Жильё и аренда', icon: '🏠', color: '#000091',
    phrases: [
      { greek: 'Je suis intéressé par l’annonce', transcription: 'Жё сюи́ энтересэ́ пар лянонс', translation: 'Меня интересует объявление', note: 'Первая фраза звонка агенту или владельцу.' },
      { greek: 'Est-ce que les charges sont comprises ?', transcription: 'Эскё ле шарж сон компри́з ?', translation: 'Коммунальные включены?', note: 'CC — charges comprises, HC — hors charges.' },
      { greek: 'Quel est le montant des charges ?', transcription: 'Кэль э лё монта́н де шарж ?', translation: 'Какая сумма коммунальных?', note: 'Раз в год делают перерасчёт — régularisation.' },
      { greek: 'Le chauffage est individuel ou collectif ?', transcription: 'Лё шофа́ж э эндивидюэ́ль у колекти́ф ?', translation: 'Отопление индивидуальное или общее?', note: 'От этого зависит, платите вы по счётчику или в составе charges.' },
      { greek: 'Mon dossier est complet', transcription: 'Мон досье́ э комплэ́', translation: 'Моё досье полное', note: 'В крупных городах выигрывает тот, у кого документы готовы сразу.' },
      { greek: 'J’ai la garantie Visale', transcription: 'Жэ ля гаранти́ виза́ль', translation: 'У меня есть гарантия Visale', note: 'Государственная бесплатная замена поручителю.' },
      { greek: 'Quand puis-je emménager ?', transcription: 'Кан пюи́-жё амена́жэ ?', translation: 'Когда я могу въехать?', note: 'Emménager — въехать, déménager — переехать.' },
      { greek: 'Il y a une fissure ici, notez-le', transcription: 'Иль-я юн фисю́р иси́, нотэ́-лё', translation: 'Здесь трещина, отметьте её', note: 'Ключевая фраза при описи état des lieux — она защищает депозит.' },
      { greek: 'Le robinet fuit', transcription: 'Лё робинэ́ фюи́', translation: 'Кран течёт', note: 'Мелкий ремонт — за жильцом, поломка труб — за владельцем.' },
      { greek: 'Je donne mon préavis', transcription: 'Жё дон мон преави́', translation: 'Я подаю уведомление о выезде', note: 'Отправляют заказным письмом с уведомлением о вручении.' },
      { greek: 'Quand serai-je remboursé du dépôt ?', transcription: 'Кан сёрэ́-жё рамбурсэ́ дю депо́ ?', translation: 'Когда мне вернут депозит?', note: 'Месяц при совпадении описей, два месяца при удержаниях.' },
      { greek: 'Je cherche un deux-pièces', transcription: 'Жё шерш эн дё-пьес', translation: 'Я ищу двухкомнатную', note: 'T2 — гостиная плюс спальня; кухня в счёт комнат не входит.' },
      { greek: 'C’est meublé ou vide ?', transcription: 'Сэ мёблэ́ у вид ?', translation: 'Это меблированная или пустая?', note: 'От этого зависят срок договора, préavis и размер депозита.' },
      { greek: 'Il faut une assurance habitation ?', transcription: 'Иль фо юн асюра́нс абитасьо́н ?', translation: 'Нужна страховка жилья?', note: 'Обязательна по закону, подтверждение просят ежегодно.' },
      { greek: 'Je peux visiter cette semaine ?', transcription: 'Жё пё визитэ́ сэт сёмэ́н ?', translation: 'Могу посмотреть на этой неделе?', note: 'Visiter — про осмотр жилья, а не про «навестить».' },
    ]
  },
  {
    id: 'neighbors_ph', category: 'Соседи и дом', icon: '🏘️', color: '#000091',
    phrases: [
      { greek: 'Bonjour, je viens d’emménager', transcription: 'Бонжу́р, жё вье́н дамена́жэ', translation: 'Здравствуйте, я недавно въехал', note: 'Знакомство с соседями снимает половину будущих конфликтов.' },
      { greek: 'On fait une fête samedi, désolé pour le bruit', transcription: 'Он фэ юн фэт самди́, дезоле́ пур лё брюи́', translation: 'В субботу у нас праздник, извините за шум', note: 'Предупредить запиской в подъезде — обязательная вежливость.' },
      { greek: 'On entend beaucoup de bruit le soir', transcription: 'Он анта́н боку́ дё брюи́ лё суа́р', translation: 'Вечером очень слышно шум', note: 'Нейтральная формулировка для первого разговора о шуме.' },
      { greek: 'Le code de la porte a changé ?', transcription: 'Лё код дё ля порт а шанжэ́ ?', translation: 'Код от двери поменяли?', note: 'Digicode меняют время от времени, объявление вешают в подъезде.' },
      { greek: 'Il y a une fuite qui vient de chez vous', transcription: 'Иль-я юн фюи́т ки вье́н дё ше ву', translation: 'Протечка идёт от вас', note: 'Дальше составляют constat amiable — совместный акт.' },
      { greek: 'On remplit un constat amiable ?', transcription: 'Он рампли́ эн конста́ амья́бль ?', translation: 'Заполним совместный акт?', note: 'Каждый передаёт экземпляр в свою страховую в течение пяти дней.' },
      { greek: 'J’ai déclaré le sinistre à mon assurance', transcription: 'Жэ деклярэ́ лё синистр а мон асюра́нс', translation: 'Я сообщил о происшествии в страховую', note: 'Sinistre — страховой случай, не обязательно катастрофа.' },
      { greek: 'L’ascenseur ne marche pas', transcription: 'Лясансё́р нё марш па', translation: 'Лифт не работает', note: 'Общее имущество — вопрос к syndic, а не к владельцу квартиры.' },
      { greek: 'Je vais faire des travaux', transcription: 'Жё вэ фэр де траво́', translation: 'У меня будет ремонт', note: 'Записка соседям заранее избавляет от жалоб.' },
      { greek: 'Vous pouvez me donner un coup de main ?', transcription: 'Ву пуве́ мё донэ́ эн ку дё мэн ?', translation: 'Можете мне помочь?', note: 'Coup de main — про помощь, а не про удар.' },
      { greek: 'Où est le local à poubelles ?', transcription: 'У э лё лока́ль а пубэ́ль ?', translation: 'Где мусорное помещение?', note: 'Жёлтая крышка — сортировка, стекло отдельно.' },
      { greek: 'Je voudrais contacter le syndic', transcription: 'Жё вудрэ́ контактэ́ лё сэнди́к', translation: 'Я хотел бы связаться с управляющим', note: 'Syndic отвечает за подъезд, лифт, общее отопление.' },
      { greek: 'Le chauffage ne marche pas', transcription: 'Лё шофа́ж нё марш па', translation: 'Отопление не работает', note: 'Норма в квартире — около 19 градусов, это не повод для жалобы.' },
      { greek: 'Je voudrais faire venir un plombier', transcription: 'Жё вудрэ́ фэр вёни́р эн пломбье́', translation: 'Я хотел бы вызвать сантехника', note: 'Всегда просите devis — смету — до начала работ.' },
      { greek: 'Vous faites un devis avant ?', transcription: 'Ву фэт эн дёви́ ава́н ?', translation: 'Вы делаете смету заранее?', note: 'Защищает от завышенных счетов, особенно при срочном вызове.' },
    ]
  },
  {
    id: 'doctor_ph', category: 'У врача и в аптеке', icon: '🏥', color: '#000091',
    phrases: [
      { greek: 'Je voudrais prendre rendez-vous', transcription: 'Жё вудрэ́ пра́ндр рандэву́', translation: 'Я хотел бы записаться на приём', note: 'Стандартное начало звонка в любой кабинет.' },
      { greek: 'Est-ce que vous prenez de nouveaux patients ?', transcription: 'Эскё ву прёнэ́ дё нуво́ пасья́н ?', translation: 'Вы берёте новых пациентов?', note: 'В крупных городах терапевты часто закрыты для новых.' },
      { greek: 'Je voudrais vous déclarer comme médecin traitant', transcription: 'Жё вудрэ́ ву деклярэ́ ком медсэ́н трэта́н', translation: 'Хочу объявить вас лечащим врачом', note: 'Без médecin traitant возмещение падает примерно втрое.' },
      { greek: 'C’est assez urgent', transcription: 'Сэ асэ́ юржа́н', translation: 'Это довольно срочно', note: 'Иногда открывает слот в тот же день.' },
      { greek: 'J’ai mal à la tête depuis trois jours', transcription: 'Жэ маль а ля тэт дёпюи́ труа́ жур', translation: 'У меня голова болит три дня', note: 'Формула: что болит + с какого времени.' },
      { greek: 'J’ai de la fièvre', transcription: 'Жэ дё ля фьевр', translation: 'У меня температура', note: 'Avoir de la fièvre, а не «быть горячим».' },
      { greek: 'Je suis allergique aux antibiotiques', transcription: 'Жё сюи́ алержи́к о антибьоти́к', translation: 'У меня аллергия на антибиотики', note: 'Скажите это до того, как врач начнёт выписывать.' },
      { greek: 'Je prends déjà ce médicament', transcription: 'Жё пран дежа́ сё медикама́н', translation: 'Я уже принимаю это лекарство', note: 'Список принимаемых препаратов лучше держать в телефоне.' },
      { greek: 'Voici ma carte Vitale', transcription: 'Вуаси́ ма карт вита́ль', translation: 'Вот моя карта Vitale', note: 'Пока карты нет, работает бумажная attestation de droits.' },
      { greek: 'Vous faites le tiers payant ?', transcription: 'Ву фэт лё тьер пэя́н ?', translation: 'Вы работаете по прямой оплате страховкой?', note: 'Разница между «заплатить и ждать возврата» и «не платить».' },
      { greek: 'Vous pouvez me faire un arrêt de travail ?', transcription: 'Ву пуве́ мё фэр эн арэ́ дё трава́й ?', translation: 'Можете выписать больничный?', note: 'Врач решает сам, но спросить нормально.' },
      { greek: 'J’ai une ordonnance', transcription: 'Жэ юн ордона́нс', translation: 'У меня рецепт', note: 'В аптеке первое, что показывают.' },
      { greek: 'Vous avez quelque chose contre la toux ?', transcription: 'Вуз-аве́ кэлькё шоз контр ля ту ?', translation: 'Есть что-нибудь от кашля?', note: 'Фармацевт консультирует бесплатно — с лёгким сначала идут к нему.' },
      { greek: 'Je le prends combien de fois par jour ?', transcription: 'Жё лё пран комбье́н дё фуа́ пар жур ?', translation: 'Сколько раз в день это принимать?', note: 'Posologie — дозировка, она же на упаковке.' },
      { greek: 'C’est une urgence !', transcription: 'Сэт юн юржа́нс !', translation: 'Это экстренный случай!', note: 'SAMU — 15, единый европейский — 112. Сразу называйте адрес и этаж.' },
    ]
  },
  {
    id: 'phone_ph', category: 'Телефон и переписка', icon: '📞', color: '#000091',
    phrases: [
      { greek: 'Allô, bonjour, c’est Ivan', transcription: 'Алё́, бонжу́р, сэ Ива́н', translation: 'Алло, здравствуйте, это Иван', note: '«Allô» — только по телефону. При встрече так не здороваются.' },
      { greek: 'Je vous appelle au sujet de…', transcription: 'Жё вуз-апэ́ль о сюжэ́ дё…', translation: 'Я звоню по поводу…', note: 'Сразу называйте тему — это ускоряет разговор.' },
      { greek: 'Je peux parler à monsieur Durand ?', transcription: 'Жё пё парле́ а мёсьё́ Дюра́н ?', translation: 'Могу поговорить с господином Дюраном?', note: 'В учреждениях чаще просят назвать номер дела, а не имя.' },
      { greek: 'Ne quittez pas', transcription: 'Нё китэ́ па', translation: 'Не кладите трубку', note: 'Услышите в ответ, когда вас переключают.' },
      { greek: 'Vous pouvez répéter plus lentement ?', transcription: 'Ву пуве́ репетэ́ плю лантёма́н ?', translation: 'Можете повторить помедленнее?', note: 'По телефону работает лучше, чем просто «répéter».' },
      { greek: 'Je vous entends mal', transcription: 'Жё вуз-анта́н маль', translation: 'Я вас плохо слышу', note: 'Нейтральная причина попросить повторить.' },
      { greek: 'Vous pouvez m’envoyer un mail ?', transcription: 'Ву пуве́ манвуайе́ эн мэйль ?', translation: 'Можете прислать мне письмо?', note: 'Письмо проще разобрать, чем беглую речь по телефону.' },
      { greek: 'Quel est votre numéro de dossier ?', transcription: 'Кэль э вотр нюмеро́ дё досье́ ?', translation: 'Какой у вас номер дела?', note: 'Держите номер под рукой до звонка.' },
      { greek: 'Je vous rappelle demain', transcription: 'Жё ву рапэ́ль дёмэ́н', translation: 'Я перезвоню вам завтра', note: 'Rappeler — перезвонить, appeler — позвонить.' },
      { greek: 'Laissez un message après le bip', transcription: 'Лэсэ́ эн меса́ж апрэ́ лё бип', translation: 'Оставьте сообщение после сигнала', note: 'Стандартный автоответчик.' },
      { greek: 'Mon numéro, c’est le zéro six…', transcription: 'Мон нюмеро́, сэ лё зеро́ сис…', translation: 'Мой номер: ноль шесть…', note: 'Французы диктуют номер парами цифр.' },
      { greek: 'Vous pouvez répéter chiffre par chiffre ?', transcription: 'Ву пуве́ репетэ́ шифр пар шифр ?', translation: 'Можете повторить по одной цифре?', note: 'Спасает от «soixante-quinze» вместо «sept, cinq».' },
      { greek: 'Je vous envoie le document en pièce jointe', transcription: 'Жё вуз-анвуа́ лё докюма́н ан пьес жуэ́нт', translation: 'Отправляю документ во вложении', note: 'Pièce jointe — вложение к письму.' },
      { greek: 'Merci de votre retour', transcription: 'Мерси́ дё вотр рёту́р', translation: 'Спасибо за ответ', note: 'Retour в переписке — это ответ, а не возврат.' },
      { greek: 'Dans l’attente de votre réponse', transcription: 'Дан лятта́нт дё вотр репо́нс', translation: 'В ожидании вашего ответа', note: 'Стандартная предпоследняя строка делового письма.' },
    ]
  },
  {
    id: 'directions_ph', category: 'Как пройти', icon: '🧭', color: '#000091',
    phrases: [
      { greek: 'Excusez-moi, je cherche la gare', transcription: 'Экскюзэ́-муа́, жё шерш ля гар', translation: 'Извините, я ищу вокзал', note: 'Начинайте с извинения — обращаться сразу с вопросом невежливо.' },
      { greek: 'Où est la station de métro ?', transcription: 'У э ля стасьо́н дё метро́ ?', translation: 'Где станция метро?', note: 'Station — метро, gare — вокзал, arrêt — остановка.' },
      { greek: 'C’est loin d’ici ?', transcription: 'Сэ луэ́н диси́ ?', translation: 'Это далеко отсюда?', note: 'Ответ часто дают в минутах ходьбы, а не в метрах.' },
      { greek: 'C’est à combien de minutes à pied ?', transcription: 'Сэт-а комбье́н дё миню́т а пье ?', translation: 'Сколько минут пешком?', note: 'À pied — пешком, en voiture — на машине.' },
      { greek: 'Allez tout droit', transcription: 'Алэ́ ту друа́', translation: 'Идите прямо', note: 'Tout droit — прямо; à droite — направо. Легко перепутать.' },
      { greek: 'Tournez à droite après le feu', transcription: 'Турнэ́ а друа́т апрэ́ лё фё', translation: 'Поверните направо после светофора', note: 'Feu — светофор, rond-point — круговое движение.' },
      { greek: 'C’est en face de la boulangerie', transcription: 'Сэт-ан фас дё ля буланжри́', translation: 'Это напротив булочной', note: 'Ориентиры во Франции чаще дают по магазинам, чем по номерам домов.' },
      { greek: 'C’est au coin de la rue', transcription: 'Сэт-о куэ́н дё ля рю', translation: 'Это на углу улицы', note: 'Au coin — на углу.' },
      { greek: 'Je suis perdu', transcription: 'Жё сюи́ пердю́', translation: 'Я заблудился', note: 'Работает и как просьба о помощи.' },
      { greek: 'Vous pouvez me montrer sur la carte ?', transcription: 'Ву пуве́ мё монтрэ́ сюр ля карт ?', translation: 'Можете показать на карте?', note: 'Снимает проблему с восприятием названий на слух.' },
      { greek: 'Je dois changer où ?', transcription: 'Жё дуа́ шанжэ́ у ?', translation: 'Где мне делать пересадку?', note: 'Correspondance — пересадка, указатель в метро.' },
      { greek: 'C’est quelle sortie ?', transcription: 'Сэ кэль сорти́ ?', translation: 'Какой это выход?', note: 'В крупных станциях выходы нумерованы, и разница — километр.' },
      { greek: 'Traversez au passage piéton', transcription: 'Траверсэ́ о паса́ж пьето́н', translation: 'Переходите по пешеходному переходу', note: 'Штрафы за переход в неположенном месте существуют, но выписывают редко.' },
      { greek: 'C’est par là ?', transcription: 'Сэ пар ля ?', translation: 'Это туда?', note: 'Короткий способ уточнить направление жестом.' },
      { greek: 'Merci, bonne journée !', transcription: 'Мерси́, бон журнэ́ !', translation: 'Спасибо, хорошего дня!', note: 'Завершайте любой уличный разговор — молча уходить невежливо.' },
    ]
  },
  {
    id: 'time_ph', category: 'Время и договорённости', icon: '⏰', color: '#000091',
    phrases: [
      { greek: 'Quelle heure est-il ?', transcription: 'Кэль ёр э-ти́ль ?', translation: 'Который час?', note: 'В расписаниях используют 24-часовой формат.' },
      { greek: 'On se voit à quelle heure ?', transcription: 'Он сё вуа́ а кэль ёр ?', translation: 'Во сколько встречаемся?', note: 'Se voir — увидеться, встретиться.' },
      { greek: 'Je serai là dans dix minutes', transcription: 'Жё сёрэ́ ля дан ди миню́т', translation: 'Я буду через десять минут', note: 'Dans — через; en dix minutes значило бы «за десять минут».' },
      { greek: 'Je suis en retard, désolé', transcription: 'Жё сюи́ ан рёта́р, дезоле́', translation: 'Я опаздываю, извините', note: 'Опоздание на 5–10 минут в быту терпимо, на приём — нет.' },
      { greek: 'On peut décaler d’une heure ?', transcription: 'Он пё декалэ́ дюн ёр ?', translation: 'Можем сдвинуть на час?', note: 'Décaler — сдвинуть по времени.' },
      { greek: 'Ça vous va, mardi matin ?', transcription: 'Са ву ва, марди́ матэ́н ?', translation: 'Вам подходит во вторник утром?', note: 'Ça vous va ? — «вам подходит?».' },
      { greek: 'Je suis disponible après dix-huit heures', transcription: 'Жё сюи́ диспони́бль апрэ́ диз-юи́т ёр', translation: 'Я свободен после шести вечера', note: 'Disponible — свободен, доступен.' },
      { greek: 'C’est ouvert jusqu’à quelle heure ?', transcription: 'Сэт-увэ́р жюска́ кэль ёр ?', translation: 'До скольки открыто?', note: 'Многие мелкие магазины закрываются на обед.' },
      { greek: 'C’est fermé le dimanche', transcription: 'Сэ фермэ́ лё диманш', translation: 'По воскресеньям закрыто', note: 'Артикль le перед днём означает «каждое воскресенье».' },
      { greek: 'On est le combien aujourd’hui ?', transcription: 'Он э лё комбье́н ожурдюи́ ?', translation: 'Какое сегодня число?', note: 'Стандартная разговорная форма вопроса о дате.' },
      { greek: 'La semaine prochaine, si possible', transcription: 'Ля сёмэ́н прошэ́н, си поси́бль', translation: 'На следующей неделе, если можно', note: 'Prochaine — следующая, dernière — прошлая.' },
      { greek: 'Ça fait combien de temps ?', transcription: 'Са фэ комбье́н дё тан ?', translation: 'Сколько времени это займёт?', note: 'Про длительность процедуры или ожидания.' },
      { greek: 'J’habite ici depuis six mois', transcription: 'Жаби́т иси́ дёпюи́ си муа́', translation: 'Я живу здесь шесть месяцев', note: 'Depuis идёт с настоящим временем, хотя по-русски это прошедшее.' },
      { greek: 'Le rendez-vous est confirmé ?', transcription: 'Лё рандэву́ э конфирмэ́ ?', translation: 'Приём подтверждён?', note: 'Подтверждение записи стоит проверять накануне.' },
      { greek: 'Désolé, je ne pourrai pas venir', transcription: 'Дезоле́, жё нё пурэ́ па вёни́р', translation: 'Извините, я не смогу прийти', note: 'Об отмене приёма предупреждают заранее, иначе бывает штраф.' },
    ]
  },
  {
    id: 'feelings_ph', category: 'Чувства и реакции', icon: '😊', color: '#000091',
    phrases: [
      { greek: 'Ça me plaît beaucoup', transcription: 'Са мё плэ боку́', translation: 'Мне это очень нравится', note: 'Plaire строится наоборот: не «я люблю», а «оно мне нравится».' },
      { greek: 'Je suis content de vous voir', transcription: 'Жё сюи́ конта́н дё ву вуа́р', translation: 'Рад вас видеть', note: 'В женском роде — contente, на слух слышна конечная «т».' },
      { greek: 'Ça m’énerve', transcription: 'Са менэ́рв', translation: 'Меня это раздражает', note: 'Разговорно и совершенно нормально в быту.' },
      { greek: 'Je suis fatigué', transcription: 'Жё сюи́ фатигэ́', translation: 'Я устал', note: 'Разговорный вариант — «je suis crevé».' },
      { greek: 'Ne vous inquiétez pas', transcription: 'Нё вуз-энкьетэ́ па', translation: 'Не беспокойтесь', note: 'На «ты» — «t’inquiète», очень частая разговорная форма.' },
      { greek: 'C’est pas grave', transcription: 'Сэ па грав', translation: 'Ничего страшного', note: 'В речи ne опускают: полная форма — «ce n’est pas grave».' },
      { greek: 'Tant pis', transcription: 'Тан пи', translation: 'Ну и ладно', note: 'Противоположность — «tant mieux», тем лучше.' },
      { greek: 'Ça vaut le coup', transcription: 'Са во лё ку', translation: 'Оно того стоит', note: 'Очень частый бытовой оборот.' },
      { greek: 'Ça craint', transcription: 'Са крэн', translation: 'Плохо дело', note: 'Разговорное. С коллегами уместно, в администрации — нет.' },
      { greek: 'Je suis déçu', transcription: 'Жё сюи́ десю́', translation: 'Я разочарован', note: 'Мягче, чем открытая жалоба.' },
      { greek: 'C’est dommage', transcription: 'Сэ дома́ж', translation: 'Жаль', note: 'Нейтральное сожаление, годится везде.' },
      { greek: 'Je n’en peux plus', transcription: 'Жё нан пё плю', translation: 'Я больше не могу', note: 'Об усталости, а не об отказе продолжать разговор.' },
      { greek: 'Ça me stresse', transcription: 'Са мё стрэс', translation: 'Меня это нервирует', note: 'Англицизм, полностью прижившийся во французском.' },
      { greek: 'Félicitations !', transcription: 'Фелиситасьо́н !', translation: 'Поздравляю!', note: 'Об успехе: работа, экзамен, гражданство.' },
      { greek: 'Je vous souhaite bon courage', transcription: 'Жё ву суэ́т бон кура́ж', translation: 'Желаю вам удачи и сил', note: 'Bon courage говорят перед трудным делом, а не после.' },
    ]
  },
  {
    id: 'slang_ph', category: 'Разговорные обороты', icon: '😎', color: '#000091',
    phrases: [
      { greek: 'Ça marche', transcription: 'Са марш', translation: 'Договорились', note: 'Тот же глагол значит «работает» о технике.' },
      { greek: 'Du coup, on fait quoi ?', transcription: 'Дю ку, он фэ куа́ ?', translation: 'Так что делаем?', note: '«Du coup» — слово-паразит уровня русского «короче».' },
      { greek: 'Bref, c’est compliqué', transcription: 'Брэф, сэ комплике́', translation: 'Короче, всё сложно', note: 'Bref подводит итог сказанному.' },
      { greek: 'J’ai du boulot', transcription: 'Жэ дю було́', translation: 'У меня много работы', note: 'Boulot — разговорное «работа», в письме не используют.' },
      { greek: 'Je suis crevé', transcription: 'Жё сюи́ крёвэ́', translation: 'Я вымотан', note: 'Разговорный синоним fatigué.' },
      { greek: 'C’est nickel', transcription: 'Сэ никэ́ль', translation: 'Отлично, идеально', note: 'Буквально «никель» — то есть блестяще чисто.' },
      { greek: 'C’est relou', transcription: 'Сэ рёлу́', translation: 'Это занудно, достало', note: 'Verlan от lourd — слоги переставлены местами.' },
      { greek: 'C’est chelou', transcription: 'Сэ шёлу́', translation: 'Это странно, подозрительно', note: 'Verlan от louche.' },
      { greek: 'C’est ouf', transcription: 'Сэт-уф', translation: 'Это безумно круто', note: 'Verlan от fou.' },
      { greek: 'T’inquiète', transcription: 'Тэнкье́т', translation: 'Не переживай', note: 'Сокращение от «ne t’inquiète pas». Только на «ты».' },
      { greek: 'Laisse tomber', transcription: 'Лэс томбэ́', translation: 'Забей', note: 'Буквально «дай упасть».' },
      { greek: 'N’importe quoi !', transcription: 'Нэмпо́рт куа́ !', translation: 'Что за бред!', note: 'Реакция на нелепость. С незнакомыми звучит резко.' },
      { greek: 'C’est grave bien', transcription: 'Сэ грав бье́н', translation: 'Это реально круто', note: 'В разговорной речи grave работает как усилитель.' },
      { greek: 'Je sais pas', transcription: 'Ше па', translation: 'Не знаю', note: 'В речи «je ne sais pas» стягивается почти в один слог.' },
      { greek: 'Ça roule', transcription: 'Са руль', translation: 'Всё идёт, порядок', note: 'Неформальный аналог «ça marche».' },
    ]
  },
  {
    id: 'holidays_ph', category: 'Праздники и поздравления', icon: '🎉', color: '#000091',
    phrases: [
      { greek: 'Bonne année !', transcription: 'Бон анэ́ !', translation: 'С Новым годом!', note: 'Поздравляют не заранее, а начиная с 1 января и весь месяц.' },
      { greek: 'Joyeux Noël !', transcription: 'Жуайё́ ноэ́ль !', translation: 'С Рождеством!', note: 'Главный семейный ужин — в ночь с 24 на 25.' },
      { greek: 'Joyeux anniversaire !', transcription: 'Жуайё́ аниверсэ́р !', translation: 'С днём рождения!', note: 'Anniversaire — и день рождения, и годовщина.' },
      { greek: 'Bonnes vacances !', transcription: 'Бон вака́нс !', translation: 'Хорошего отпуска!', note: 'Vacances всегда во множественном числе.' },
      { greek: 'Bon week-end !', transcription: 'Бон уик-э́нд !', translation: 'Хороших выходных!', note: 'Говорят в пятницу всем подряд, включая кассира.' },
      { greek: 'Bonne fête !', transcription: 'Бон фэт !', translation: 'С праздником!', note: 'Также поздравление с именинами по церковному календарю.' },
      { greek: 'Meilleurs vœux', transcription: 'Мэйё́р вё', translation: 'Наилучшие пожелания', note: 'Формула для новогодних открыток.' },
      { greek: 'Santé !', transcription: 'Сантэ́ !', translation: 'За здоровье!', note: 'Короткий тост. Полная форма — «à votre santé».' },
      { greek: 'On trinque ?', transcription: 'Он трэнк ?', translation: 'Чокнемся?', note: 'Смотреть в глаза при чокании — местная норма.' },
      { greek: 'Bon appétit !', transcription: 'Бон апети́ !', translation: 'Приятного аппетита!', note: 'Говорят обязательно, в том числе незнакомым за соседним столом.' },
      { greek: 'Tous mes vœux de bonheur', transcription: 'Ту мэ вё дё бонё́р', translation: 'Счастья вам', note: 'Поздравление на свадьбу.' },
      { greek: 'Toutes mes condoléances', transcription: 'Тут ме кондолеа́нс', translation: 'Мои соболезнования', note: 'Стандартная формула, другой не нужно.' },
      { greek: 'Je vous invite à dîner', transcription: 'Жё вуз-энви́т а динэ́', translation: 'Приглашаю вас на ужин', note: 'В гости во Франции приходят на 10–15 минут позже назначенного.' },
      { greek: 'J’apporte le dessert', transcription: 'Жапо́рт лё десэ́р', translation: 'Я принесу десерт', note: 'Прийти с вином или десертом — обычная практика.' },
      { greek: 'Pas de chrysanthèmes, s’il vous plaît', transcription: 'Па дё кризантэ́м, силь ву плэ', translation: 'Только не хризантемы', note: 'Хризантема во Франции — цветок кладбищ, живым её не дарят.' },
    ]
  }
];
...
const QUIZ_CATEGORIES = [
  ...
  {
    id: 'work_quiz', emoji: '💼', title: 'Работа и офис',
    sentences: [
      { ru: 'Я работаю в отделе маркетинга.', words: ['Je', 'travaille', 'dans', 'le', 'service', 'marketing.'], diff: 2 },
      { ru: 'У вас есть пять минут?', words: ['Est-ce', 'que', 'vous', 'avez', 'cinq', 'minutes', '?'], diff: 2 },
      { ru: 'Я хотел бы взять неделю отпуска.', words: ['Je', 'voudrais', 'poser', 'une', 'semaine', 'de', 'congés.'], diff: 3 },
      { ru: 'Не могли бы вы прислать мне документ?', words: ['Pourriez-vous', 'm’envoyer', 'le', 'document', '?'], diff: 2 },
      { ru: 'Я сейчас завален работой.', words: ['Je', 'suis', 'débordé', 'en', 'ce', 'moment.'], diff: 2 },
      { ru: 'Ставлю вас в копию.', words: ['Je', 'vous', 'mets', 'en', 'copie.'], diff: 2 },
      { ru: 'Я не совсем согласен.', words: ['Je', 'ne', 'suis', 'pas', 'tout', 'à', 'fait', 'd’accord.'], diff: 3 },
      { ru: 'Сверимся завтра?', words: ['On', 'fait', 'un', 'point', 'demain', '?'], diff: 2 },
      { ru: 'У меня больничный на три дня.', words: ['J’ai', 'un', 'arrêt', 'de', 'travail', 'de', 'trois', 'jours.'], diff: 3 },
      { ru: 'Я заканчиваю работу в шесть вечера.', words: ['Je', 'termine', 'le', 'travail', 'à', 'dix-huit', 'heures.'], diff: 2 },
      { ru: 'Мне нужно больше времени на этот проект.', words: ['J’ai', 'besoin', 'de', 'plus', 'de', 'temps', 'sur', 'ce', 'dossier.'], diff: 3 },
      { ru: 'Спасибо за ваш ответ.', words: ['Merci', 'de', 'votre', 'retour.'], diff: 1 },
    ]
  },
  {
    id: 'school_quiz', emoji: '🎒', title: 'Школа и дети',
    sentences: [
      { ru: 'Я хотел бы записать ребёнка в школу.', words: ['Je', 'voudrais', 'inscrire', 'mon', 'enfant', 'à', 'l’école.'], diff: 2 },
      { ru: 'Мы недавно приехали во Францию.', words: ['Nous', 'venons', 'd’arriver', 'en', 'France.'], diff: 2 },
      { ru: 'Мой ребёнок пока не говорит по-французски.', words: ['Mon', 'enfant', 'ne', 'parle', 'pas', 'encore', 'français.'], diff: 3 },
      { ru: 'В этом году он в первом классе.', words: ['Il', 'est', 'en', 'CP', 'cette', 'année.'], diff: 2 },
      { ru: 'У него аллергия на арахис.', words: ['Il', 'a', 'une', 'allergie', 'aux', 'arachides.'], diff: 2 },
      { ru: 'Как у него проходит год?', words: ['Comment', 'se', 'passe', 'l’année', 'pour', 'lui', '?'], diff: 3 },
      { ru: 'В чём у него трудности?', words: ['Il', 'a', 'des', 'difficultés', 'en', 'quoi', '?'], diff: 2 },
      { ru: 'Мой ребёнок болел вчера.', words: ['Mon', 'enfant', 'était', 'malade', 'hier.'], diff: 2 },
      { ru: 'Во сколько заканчиваются уроки?', words: ['À', 'quelle', 'heure', 'finit', 'l’école', '?'], diff: 2 },
      { ru: 'Извините, мой французский несовершенен.', words: ['Excusez-moi,', 'mon', 'français', 'n’est', 'pas', 'parfait.'], diff: 3 },
      { ru: 'Можете мне это написать?', words: ['Vous', 'pouvez', 'me', 'l’écrire', '?'], diff: 2 },
      { ru: 'Спасибо за внимание к ребёнку.', words: ['Merci', 'beaucoup', 'pour', 'votre', 'suivi.'], diff: 1 },
    ]
  },
  {
    id: 'restaurant_quiz', emoji: '🍽️', title: 'Ресторан и еда',
    sentences: [
      { ru: 'Столик на двоих, пожалуйста.', words: ['Une', 'table', 'pour', 'deux,', 's’il', 'vous', 'plaît.'], diff: 1 },
      { ru: 'Меню, пожалуйста.', words: ['La', 'carte,', 's’il', 'vous', 'plaît.'], diff: 1 },
      { ru: 'Что вы посоветуете?', words: ['Qu’est-ce', 'que', 'vous', 'me', 'conseillez', '?'], diff: 2 },
      { ru: 'Я возьму блюдо дня.', words: ['Je', 'prends', 'le', 'plat', 'du', 'jour.'], diff: 1 },
      { ru: 'Графин воды, пожалуйста.', words: ['Une', 'carafe', 'd’eau,', 's’il', 'vous', 'plaît.'], diff: 2 },
      { ru: 'У меня аллергия на морепродукты.', words: ['Je', 'suis', 'allergique', 'aux', 'fruits', 'de', 'mer.'], diff: 3 },
      { ru: 'Я вегетарианец.', words: ['Je', 'suis', 'végétarien.'], diff: 1 },
      { ru: 'Счёт, пожалуйста.', words: ['L’addition,', 's’il', 'vous', 'plaît.'], diff: 1 },
      { ru: 'Можно заплатить раздельно?', words: ['On', 'peut', 'payer', 'séparément', '?'], diff: 2 },
      { ru: 'Было очень вкусно, спасибо.', words: ['C’était', 'très', 'bon,', 'merci.'], diff: 2 },
      { ru: 'Мясо средней прожарки, пожалуйста.', words: ['À', 'point,', 's’il', 'vous', 'plaît.'], diff: 2 },
      { ru: 'Можно попробовать этот сыр?', words: ['Je', 'peux', 'goûter', 'ce', 'fromage', '?'], diff: 2 },
    ]
  },
  {
    id: 'bank_quiz', emoji: '🏦', title: 'Банк и деньги',
    sentences: [
      { ru: 'Я хотел бы открыть счёт.', words: ['Je', 'voudrais', 'ouvrir', 'un', 'compte.'], diff: 1 },
      { ru: 'Какие документы нужны?', words: ['Quels', 'documents', 'faut-il', '?'], diff: 2 },
      { ru: 'Какая плата за обслуживание счёта?', words: ['Quels', 'sont', 'les', 'frais', 'de', 'tenue', 'de', 'compte', '?'], diff: 3 },
      { ru: 'Я хотел бы сделать перевод.', words: ['Je', 'voudrais', 'faire', 'un', 'virement.'], diff: 1 },
      { ru: 'Я потерял карту.', words: ['J’ai', 'perdu', 'ma', 'carte.'], diff: 1 },
      { ru: 'Я не узнаю эту операцию.', words: ['Je', 'n’ai', 'pas', 'reconnu', 'cette', 'opération.'], diff: 3 },
      { ru: 'Какой остаток на моём счёте?', words: ['Quel', 'est', 'le', 'solde', 'de', 'mon', 'compte', '?'], diff: 2 },
      { ru: 'Я хотел бы снять сто евро.', words: ['Je', 'voudrais', 'retirer', 'cent', 'euros.'], diff: 2 },
      { ru: 'Можете прислать мне мой RIB?', words: ['Vous', 'pouvez', 'm’envoyer', 'mon', 'RIB', '?'], diff: 2 },
      { ru: 'Я хотел бы отменить это списание.', words: ['Je', 'voudrais', 'annuler', 'ce', 'prélèvement.'], diff: 2 },
      { ru: 'Вы принимаете чеки?', words: ['Vous', 'acceptez', 'les', 'chèques', '?'], diff: 1 },
      { ru: 'Мне нужен самый простой тариф.', words: ['Je', 'voudrais', 'l’offre', 'la', 'plus', 'simple.'], diff: 3 },
    ]
  },
  {
    id: 'time_quiz', emoji: '⏰', title: 'Время и договорённости',
    sentences: [
      { ru: 'Который час?', words: ['Quelle', 'heure', 'est-il', '?'], diff: 1 },
      { ru: 'Во сколько встречаемся?', words: ['On', 'se', 'voit', 'à', 'quelle', 'heure', '?'], diff: 2 },
      { ru: 'Я буду через десять минут.', words: ['Je', 'serai', 'là', 'dans', 'dix', 'minutes.'], diff: 2 },
      { ru: 'Я опаздываю, извините.', words: ['Je', 'suis', 'en', 'retard,', 'désolé.'], diff: 1 },
      { ru: 'Можем сдвинуть на час?', words: ['On', 'peut', 'décaler', 'd’une', 'heure', '?'], diff: 3 },
      { ru: 'Я свободен после шести вечера.', words: ['Je', 'suis', 'disponible', 'après', 'dix-huit', 'heures.'], diff: 2 },
      { ru: 'До скольки открыто?', words: ['C’est', 'ouvert', 'jusqu’à', 'quelle', 'heure', '?'], diff: 3 },
      { ru: 'По воскресеньям закрыто.', words: ['C’est', 'fermé', 'le', 'dimanche.'], diff: 1 },
      { ru: 'Какое сегодня число?', words: ['On', 'est', 'le', 'combien', 'aujourd’hui', '?'], diff: 2 },
      { ru: 'На следующей неделе, если можно.', words: ['La', 'semaine', 'prochaine,', 'si', 'possible.'], diff: 2 },
      { ru: 'Я живу здесь шесть месяцев.', words: ['J’habite', 'ici', 'depuis', 'six', 'mois.'], diff: 2 },
      { ru: 'Извините, я не смогу прийти.', words: ['Désolé,', 'je', 'ne', 'pourrai', 'pas', 'venir.'], diff: 3 },
    ]
  },
  {
    id: 'smalltalk_quiz', emoji: '💬', title: 'Разговор о жизни',
    sentences: [
      { ru: 'Меня зовут Анна, приятно познакомиться.', words: ['Je', 'm’appelle', 'Anna,', 'enchantée.'], diff: 2 },
      { ru: 'Я живу в Лионе шесть месяцев.', words: ['J’habite', 'à', 'Lyon', 'depuis', 'six', 'mois.'], diff: 2 },
      { ru: 'Я женат, у меня двое детей.', words: ['Je', 'suis', 'marié', 'et', 'j’ai', 'deux', 'enfants.'], diff: 2 },
      { ru: 'Сегодня хорошая погода.', words: ['Il', 'fait', 'beau', 'aujourd’hui.'], diff: 1 },
      { ru: 'Завтра будет дождь.', words: ['Il', 'va', 'pleuvoir', 'demain.'], diff: 2 },
      { ru: 'Мне это очень нравится.', words: ['Ça', 'me', 'plaît', 'beaucoup.'], diff: 2 },
      { ru: 'Ничего страшного.', words: ['C’est', 'pas', 'grave.'], diff: 1 },
      { ru: 'Мои родители живут в России.', words: ['Mes', 'parents', 'habitent', 'en', 'Russie.'], diff: 2 },
      { ru: 'Я учу французский каждый вечер.', words: ['J’apprends', 'le', 'français', 'tous', 'les', 'soirs.'], diff: 2 },
      { ru: 'Я работаю и учусь одновременно.', words: ['Je', 'travaille', 'et', 'j’étudie', 'en', 'même', 'temps.'], diff: 3 },
      { ru: 'Желаю вам удачи и сил.', words: ['Je', 'vous', 'souhaite', 'bon', 'courage.'], diff: 2 },
      { ru: 'Спасибо, хорошего дня!', words: ['Merci,', 'bonne', 'journée', '!'], diff: 1 },
    ]
  }
];
